"""Domain model for research_knowledge_recall family requests."""
...
class ResearchKnowledgeRecallFamilyRequest(BaseModel):
    """Runtime-facing input for the research_knowledge_recall family service."""
    ...
    preferred_tool: str | None = Field(
        default=None,
        description="Optional preferred tool identifier within the research_knowledge_recall family.",
    )

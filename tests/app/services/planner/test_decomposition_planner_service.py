...
from app.domain.enums import PlanningDepth, TaskType, WorkflowPattern
...
def test_topic_exploration_generates_shallow_plan() -> None:
    ...
    assert any("background knowledge" in item for item in state.initial_evidence_strategy)
...
def test_planning_depth_is_selected_from_task_type() -> None:
    context = _context(

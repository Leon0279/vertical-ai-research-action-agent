"""Domain model for arxiv_paper_search tool results."""
...
class ArxivPaperSearchToolResult(BaseModel):
    """Normalized runtime output returned by the arxiv_paper_search tool."""
    ...
    retrieval_trace: dict[str, Any] = Field(
        default_factory=dict,
        description="Compact trace of selected papers and content fetch outcomes.",
    )

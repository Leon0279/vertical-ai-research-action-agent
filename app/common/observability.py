...
_STRUCTURED_FIELDS = (
    ...
    "finding_caveats",
    "total_processed_evidence_count",
    "processing_status",
    "candidate_material_count",
    "processed_evidence_count",
    "retrieval_history_count",
    "history_update_status",
    "history_skip_reason",
    "new_retrieval_attempt_count",
    "retrieval_history_truncated_count",
    "retrieval_attempts",
    "coverage_target_count",
    "identified_gap_count",
    "current_assessment",
    "identified_gaps",
    "top_gap",
    "next_evidence_need",
